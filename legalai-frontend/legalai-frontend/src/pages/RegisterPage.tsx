      ...
      <Card className="w-full max-w-[440px] shadow-lg rounded-xl border-0">
        <CardContent className="p-8">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            {step === "verify"
              ? "Check your email for a 6-character code, then enter it below to activate your account."
          ...
          {step === "verify" ? (
            <form onSubmit={submitVerify} className="space-y-5">
              ...
              <Button
                ...
                onClick={() => { setStep("register"); setCode(""); setError(null); setResendMessage(null); }}
                disabled={loading}
              >
