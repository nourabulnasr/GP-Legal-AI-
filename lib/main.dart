...
import 'package:legato_mobile/demo/demo_app_services.dart';
import 'package:legato_mobile/demo/demo_config.dart';
...
class _LegatoAppState extends State<LegatoApp> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        Provider<AppServices>(create: (_) => kDemoMode ? DemoAppServices() : AppServices()),
